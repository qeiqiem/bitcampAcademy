            ...
            <form action="">
                ...
                <div class="join_list">
                    ...
                    <div class="join_input">
                        <ul>
                            <li>
                                <input type="text" name="mname" value=${session.members.mname }>

                            </li>

                            <li>
                                <input type="text" name="id" value=${session.members.id }>
                            </li>
                            ...
                            <li>
                                <div class="phone_no">
                                    ...
                                    <input type="text" name="phone2" size="6" value=${session.members.phone2 } > -
                                    <input type="text" name="phone3" size="6" value=${session.members.phone3 }>
                                </div>
                            </li>

                            <li>
                                <input type="text" size="30" value=${session.members.address }>
                            </li>
                        </ul>
                    </div>
