...
<header class="head_container">
	<nav class="head">
		...
		<div class="head_right">
			<input name="name" id="name" value="${sessionScope.user.name} 님"
				readonly />
			<div id="bellBox">
				<i class="fas fa-bell"></i> <span class="redDot">●</span>
				<div id="noticeBox">
					<ul>
			...
			<div id="chatBox">
				<i class="fas fa-comments"></i> <span class="redDot">●</span>
			</div>
			<a href="/jsp/mypageUser/mypagePs.jsp">마이페이지</a>
			<!--<a href="/jsp/mypageUser/Test_mybio.jsp">마이페이지</a>-->
			<a href="/logout.do">로그아웃</a> <a href="/jsp/faq.jsp">FAQ</a>
		</div>
	</nav>
</header>
